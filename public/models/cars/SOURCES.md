...
| **Käferkraft** (buggy) | `kaeferkraft.glb` | [GetGLB Buggy](https://www.getglb.com/vehicles/buggy/) pruned + comic mats (`npm run cars:polish`) | Free via GetGLB |
...
| **Bunker** (armor) | `bunker.glb` | [GetGLB Military Truck](https://www.getglb.com/vehicles/military-truck/); arcade `scale: 0.68` in `carModels.ts` | Free via GetGLB |
