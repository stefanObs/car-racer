...
function buildSportCar(car: CarState): ComicCarParts {
  ...
  const body = withOutline(new RoundedBoxGeometry(1.65, 0.42, 2.55, 5, 0.2), paint, 0.042);
  body.position.set(0, 0.52, 0.08);

  const belly = withOutline(new RoundedBoxGeometry(1.55, 0.28, 2.35, 5, 0.18), paintShade, 0.036);
  belly.position.set(0, 0.34, 0.05);

  const nose = withOutline(new SphereGeometry(0.55, 14, 12), paint, 0.038);
  nose.scale.set(1.35, 0.55, 1.1);
  nose.position.set(0, 0.48, 1.45);

  const tail = withOutline(new SphereGeometry(0.62, 14, 12), paint, 0.038);
  tail.scale.set(1.4, 0.58, 0.9);
  tail.position.set(0, 0.5, -1.25);

  const cabin = withOutline(new SphereGeometry(0.72, 14, 12), glass, 0.040);
  cabin.scale.set(1.05, 0.72, 1.15);
  cabin.position.set(0, 0.95, -0.05);

  const roof = withOutline(new RoundedBoxGeometry(0.95, 0.08, 0.85, 3, 0.040), dark, 0.045);
  roof.position.set(0, 1.28, -0.08);

  const wing = withOutline(new RoundedBoxGeometry(1.7, 0.09, 0.4, 3, 0.036), dark, 0.042);
  ...
  const diffuser = withOutline(new RoundedBoxGeometry(1.2, 0.18, 0.35, 2, 0.036), dark, 0.045);
...
function buildPickupCar(car: CarState): ComicCarParts {
  ...
  const body = withOutline(new RoundedBoxGeometry(1.85, 0.55, 2.9, 3, 0.12), paint, 0.042);
  body.position.set(0, 0.62, 0);

  const belly = withOutline(new RoundedBoxGeometry(1.75, 0.32, 2.7, 3, 0.1), paintShade, 0.036);
  belly.position.set(0, 0.38, 0);

  // Tall forward cabin (pickup cab)
  const cabin = withOutline(new RoundedBoxGeometry(1.7, 0.85, 1.15, 3, 0.1), paint, 0.042);
  ...
  const roof = withOutline(new RoundedBoxGeometry(1.55, 0.12, 1.05, 2, 0.036), dark, 0.045);
  roof.position.set(0, 1.65, 0.5);

  // Open cargo bed
  const bedFloor = withOutline(new RoundedBoxGeometry(1.65, 0.12, 1.35, 2, 0.036), paintShade, 0.045);
  ...
  // Bull bar
  const bull = withOutline(new RoundedBoxGeometry(1.7, 0.35, 0.22, 2, 0.040), chrome, 0.036);
  ...
  overlays.position.y = 0.05;
  overlays.scale.set(1.02, 1.05, 1.02);
