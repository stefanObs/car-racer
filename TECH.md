...
| F5 | Mesh studio: car on green (violet if the paint is green), mesh names + mesh-space meters; RMB copies. **E** / **Platzieren**: click mesh, **K** one edge, **R** turn whole mesh, **G** move; [ ] yaw; Home resets |
