...
- [ ] Equipped silhouette Teile are **Tripo/extract GLBs** (not procedural boxes) — check garage with parts on; only brakes (Donnerbüchse) and Große Räder overlays (Donnerbüchse/Bunker) may be procedural; Blitz/Bison/Käferkraft scale `StockWheel_*`
