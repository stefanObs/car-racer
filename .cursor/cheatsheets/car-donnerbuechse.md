...
| --- | --- | --- | --- | --- | --- | --- |
| `BodyPaint` | `BodyPaint` | 11 | 4444 | (0, 0.777, 0) | (-1.186, 0, -1.9) → (1.186, 1.554, 1.9) | BodyPaint |
...
| `StockEngine` | `StockEngine` | 2 | 1423 | (0, 0.777, 0.394) | (-1.03, 0.164, -0.732) → (1.03, 1.391, 1.521) | StockEngine |
