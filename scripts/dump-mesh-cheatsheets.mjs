...
const TRACKS = [
  ...
  },
  {
    ...
    segments: [
      { type: "straight", length: 142.8, width: 13 },
      { type: "s_curve", width: 12 },
      { type: "straight", length: 142.8, width: 13 },
      { type: "curve_r", radius: 42, angleDeg: 90, width: 11 },
      { type: "straight", length: 109.2, width: 12 },
      { type: "s_curve", width: 11 },
      { type: "straight", length: 109.2, width: 12 },
      { type: "curve_r", radius: 42, angleDeg: 90, width: 11 },
      { type: "straight", length: 142.8, width: 13 },
  ...
  },
  {
    ...
    segments: [
      ...
      { type: "uneven_field", length: 50, width: 12, intensity: 0.8 },
      ...
      { type: "s_curve", width: 11 },
      { type: "straight", length: 48, width: 12 },
      { type: "uneven_field", length: 50, width: 12, intensity: 0.55 },
      { type: "curve_r", radius: 26, angleDeg: 60, width: 10 },
      { type: "straight", length: 40, width: 11 },
      { type: "choke", length: 30, width: 8 },
      { type: "s_curve", width: 10 },
