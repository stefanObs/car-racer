...
const MOUNTS = {
  ...
  kaeferkraft: {
    ...
    reinforced_frame: [{ x: 0, y: 0, z: 0, yaw: 0, scale: 1, note: "authored in mesh space; poles Waist / WaistToFrontTop" }],
    lightweight_body: [{ x: 0.2, y: 0.5, z: 0, yaw: Math.PI / 2, scale: 1.12 }],
