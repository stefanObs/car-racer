...
const MOUNTS = {
  ...
  donnerbuechse: {
    big_engine: [{ x: 0, y: 0, z: 0, yaw: 0, scale: 1, note: "pose baked into GLB (F5 bay)" }],
...
const TRACKS = [
  ...
  },
  {
    ...
    verge: [],
    ribbon: [
      { type: "uneven", along: 280, intensity: 0.4, radius: 5 },
    ],
    segments: [
  ...
  },
  {
    ...
    segments: [
      { type: "straight", length: 90, width: 13 },
      { type: "s_curve", width: 12 },
      { type: "straight", length: 70, width: 13 },
      { type: "s_curve", width: 11 },
      { type: "straight", length: 70, width: 12 },
      { type: "curve_r", radius: 40, angleDeg: 90, width: 11 },
      { type: "straight", length: 75, width: 12 },
      { type: "s_curve", width: 11 },
      { type: "straight", length: 75, width: 12 },
      { type: "curve_r", radius: 40, angleDeg: 90, width: 11 },
      { type: "straight", length: 90, width: 13 },
  ...
  },
  {
    ...
    segments: [
      ...
      { type: "straight", length: 70, width: 12 },
      { type: "uneven_field", length: 55, width: 12, intensity: 0.75 },
      { type: "straight", length: 40, width: 12 },
      { type: "curve_r", radius: 36, angleDeg: 80, width: 10 },
      { type: "straight", length: 45, width: 12 },
      { type: "s_curve", width: 11 },
      { type: "uneven_field", length: 40, width: 11, intensity: 0.7 },
      ...
      { type: "curve_r", radius: 200, angleDeg: 10, width: 12 },
      { type: "straight", length: 70, width: 12 },
      { type: "uneven_field", length: 55, width: 12, intensity: 0.55 },
      { type: "straight", length: 40, width: 12 },
      { type: "curve_r", radius: 36, angleDeg: 80, width: 10 },
      { type: "straight", length: 45, width: 12 },
      { type: "s_curve", width: 11 },
      { type: "uneven_field", length: 40, width: 11, intensity: 0.5 },
      { type: "choke", length: 32, width: 8 },
      { type: "straight", length: 40, width: 12 },
      { type: "curve_r", radius: 34, angleDeg: 90, width: 10 },
    ],
