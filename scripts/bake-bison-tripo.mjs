#!/usr/bin/env node
/**
 * Bake Tripo Bison pickup into the arcade GLB (nose +Z, BodyPaint atlas).
 *
 * Source (gitignored under assets/tripo-out/bison/): textured model.glb
 *
 * Usage: node scripts/bake-bison-tripo.mjs
 */
...
const tripoDir = join(rootDir, "assets/tripo-out/bison");
...
/** Cab greenhouse has more high verts than the open bed — put that half at +Z (front). */
...
const orient = halfHighVerts(doc);
...
console.log("bison.glb ← Tripo pickup", {
  src,
