#!/usr/bin/env node
/**
 * Bake Tripo Bunker APC into the arcade GLB (nose +Z, BodyPaint atlas).
 *
 * Source (gitignored under assets/tripo-out/bunker/): textured model.glb
 *
 * Usage: node scripts/bake-bunker-tripo.mjs
 */
...
const tripoDir = join(rootDir, "assets/tripo-out/bunker");
...
const sized = centerSitScale(doc, { targetLen: 3.85, maxSpan: 4.05 });
...
console.log("bunker.glb ← Tripo APC", {
  src,
